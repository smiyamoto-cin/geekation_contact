    ...
    <form method="post" action="edit.php">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-8 mt-3 mb-1">
          ...
          <input type="text" name='fullname' class="form-control" id="full" placeholder="氏名" value="<?= $fullname; ?>"
            required>
        </div>
        <div class="col-md-8 m-1">
          <label for="furigana">フリガナ</label>
          <input type="text" name='furigana' class="form-control" id="furigana" placeholder="フリガナ"
            value="<?= $furigana; ?>" required>
        </div>
        <div class="col-md-8 m-1">
          <label for="tel">電話番号</label>
          <input type="text" name='tel' class="form-control" id="tel" placeholder="電話番号" value="<?= $tel; ?>"
            pattern="[0-9]*">
        </div>
        <div class="col-md-8 m-1">
          <label for="email">メールアドレス</label>
          <input type="text" name='email' class="form-control" id="email" placeholder="メールアドレス" value="<?= $email; ?>"
            required>
        </div>
        <!-- テキストエリア -->
